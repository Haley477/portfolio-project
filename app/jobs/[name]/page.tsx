...
// Correct the type for the component props to match Next.js expectations
...
const jobDetails: { [key: string]: JobDetail } = {
  "senior-web-developer-techinnovate": {
    ...
    description:
      "Led full-stack development of enterprise web applications, driving technological innovation and improving system efficiency.",
    startDate: "June 2022",
    endDate: "Present",
    responsibilities: [
  ...
  "frontend-engineering-manager-globalconnect": {
    ...
    companyLogo: "/gmc.jpg",
    description:
      "Managed a team of frontend engineers, driving innovation in user interface design and performance.",
  ...
  "ui-ux-developer-creativetech": {
    ...
    description:
      "Designed and implemented user-centric interfaces for multiple digital products and platforms.",
    startDate: "July 2020",
  ...
  "full-stack-engineer-cloudnative": {
    ...
    description:
      "Built and maintained cloud-native applications with microservices architecture.",
...
// Async metadata generation function (for the page)
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <Link href="/jobs" className="inline-block mb-6 text-gray-600 hover:text-gray-800 transition">
          ← Back to Jobs
        </Link>
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="flex justify-center py-8 bg-gray-100">
            <div className="relative w-48 h-48">
              <Image src={job.companyLogo} alt={`${job.company} Logo`} fill className="object-contain" />
            </div>
          </div>

          <div className="p-8">
            {/* Job Name */}
            <h1 className="text-4xl font-bold text-gray-800 mb-2">{job.name}</h1>
